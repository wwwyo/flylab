#!/usr/bin/env bash
# Server-side Pullfrog config for wwwyo/flylab — this file is the SSOT.
#
...
# Audit:  npx -y pullfrog@0.1.82 config list --repo wwwyo/flylab
#
